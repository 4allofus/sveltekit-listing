...
// .svelte-kit/output/server/chunks/index-862bbddd.js
...
var propToClass, Button, css, Modal, commonjsGlobal2, LARGE_ARRAY_SIZE, HASH_UNDEFINED, INFINITY$1, MAX_SAFE_INTEGER$1, argsTag$1, funcTag$1, genTag$1, symbolTag$1, reRegExpChar, reIsHostCtor, reIsUint, freeGlobal$1, freeSelf$1, root$1, arrayProto, funcProto, objectProto$1, coreJsData, maskSrcKey, funcToString, hasOwnProperty$1, objectToString$1, reIsNative, Symbol$2, getPrototype, propertyIsEnumerable$1, splice, spreadableSymbol$1, nativeGetSymbols, nativeMax$1, Map2, nativeCreate, getSymbols, getSymbolsIn, isArray$1, INFINITY, MAX_SAFE_INTEGER, argsTag, funcTag, genTag, symbolTag, freeGlobal, freeSelf, root, objectProto, hasOwnProperty, objectToString, Symbol$1, propertyIsEnumerable, spreadableSymbol, nativeMax, isArray;
var init_index_862bbddd = __esm({
  ".svelte-kit/output/server/chunks/index-862bbddd.js"() {
    init_shims();
    init_app_b78711c5();
    propToClass = {
    ...
    Button = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      classes = `paper-btn ${computeClasses("btn", { size, block, type, outline })}`;
      return `${isLink || href ? `<a class="${[escape(classes), disabled ? "disabled" : ""].join(" ").trim()}" role="${"button"}"${add_attribute("href", href, 0)}${add_attribute("target", external ? "_blank" : "_self", 0)}>${slots.default ? slots.default({}) : ``}</a>` : `<button class="${[escape(classes), disabled ? "disabled" : ""].join(" ").trim()}" ${disabled ? "disabled" : ""}>${slots.default ? slots.default({}) : ``}</button>`}`;
    });
    css = {
      code: ".btn-close.svelte-1i5he0w.svelte-1i5he0w{border:0}.btn-close.svelte-1i5he0w.svelte-1i5he0w:hover{box-shadow:none;transform:none}.modal.active.svelte-1i5he0w.svelte-1i5he0w{opacity:1;visibility:visible}.modal.active.svelte-1i5he0w .modal-body.svelte-1i5he0w{top:50%}",
      map: null
    };
...
<div class="${["modal svelte-1i5he0w", active ? "active" : ""].join(" ").trim()}"><div class="${"modal-body svelte-1i5he0w"}"><button class="${"btn-close svelte-1i5he0w"}">X
    </button>
    ...
    <footer>${$$slots.footer ? `${slots.footer ? slots.footer({}) : ``}` : ``}
      ${validate_component(Button, "Button").$$render($$result, {}, {}, { default: () => `${escape(closeBtnText)}` })}</footer></div>
</div>`;
    });
    Modal.open = open;
    ...
    reIsUint = /^(?:0|[1-9]\d*)$/;
    freeGlobal$1 = typeof commonjsGlobal2 == "object" && commonjsGlobal2 && commonjsGlobal2.Object === Object && commonjsGlobal2;
    ...
    objectToString$1 = objectProto$1.toString;
    reIsNative = RegExp("^" + funcToString.call(hasOwnProperty$1).replace(reRegExpChar, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
    Symbol$2 = root$1.Symbol;
    getPrototype = overArg(Object.getPrototypeOf, Object);
    propertyIsEnumerable$1 = objectProto$1.propertyIsEnumerable;
    splice = arrayProto.splice;
    spreadableSymbol$1 = Symbol$2 ? Symbol$2.isConcatSpreadable : void 0;
    nativeGetSymbols = Object.getOwnPropertySymbols;
    nativeMax$1 = Math.max;
    Map2 = getNative(root$1, "Map");
    ...
    baseRest$1(function(object, props) {
      if (object == null) {
        return {};
      }
    ...
    freeGlobal = typeof commonjsGlobal2 == "object" && commonjsGlobal2 && commonjsGlobal2.Object === Object && commonjsGlobal2;
    ...
    baseRest(function(object, props) {
      return object == null ? {} : basePick(object, arrayMap(baseFlatten(props, 1), toKey));
    });
  }
});

// .svelte-kit/output/server/chunks/__layout-480af0fa.js
var layout_480af0fa_exports = {};
__export(layout_480af0fa_exports, {
  default: () => _layout
});
var _layout;
var init_layout_480af0fa = __esm({
  ".svelte-kit/output/server/chunks/__layout-480af0fa.js"() {
    init_shims();
    init_app_b78711c5();
    init_index_862bbddd();
    _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let toDark = "";
      return `<nav class="${"fixed split-nav"}"><div class="${"nav-brand"}"><h3><a sveltekit:prefetch href="${"/"}">Listing Bank</a></h3></div>
    <div class="${"collapsible"}"><input id="${"collapsible1"}" type="${"checkbox"}" name="${"collapsible1"}">
      <label for="${"collapsible1"}"><div class="${"bar1"}"></div>
        <div class="${"bar2"}"></div></label>
      <div class="${"collapsible-body"}"><ul class="${"inline"}"><li><a sveltekit:prefetch href="${"/"}">Home</a></li>
          <li><a sveltekit:prefetch href="${"listing"}">listing</a></li></ul></div></div></nav>
  
<html${add_attribute("class", toDark, 0)}>${slots.default ? slots.default({}) : ``}</html>`;
    });
  }
});

// .svelte-kit/output/server/chunks/__error-096c4eb0.js
var error_096c4eb0_exports = {};
__export(error_096c4eb0_exports, {
  default: () => _error,
  load: () => load
});
...
var css2, Alert, _error;
var init_error_096c4eb0 = __esm({
  ".svelte-kit/output/server/chunks/__error-096c4eb0.js"() {
    init_shims();
    init_app_b78711c5();
    init_index_862bbddd();
    ...
    Alert = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${[
        escape(null_to_empty(classes)) + " svelte-9xbwwn",
        " " + (dismissible ? "dismissible" : "")
      ].join(" ").trim()}" role="${"alert"}">${slots.default ? slots.default({}) : ``}
  ${dismissible ? `<span class="${"btn-close"}">X</span>` : ``}
</div>`;
    });
    _error = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.title === void 0 && $$bindings.title && title !== void 0)
        $$bindings.title(title);
      return `<div class="${"row flex-middle"}"><div class="${"sm-6 col"}">${validate_component(Alert, "Alert").$$render($$result, { type: "danger" }, {}, {
        default: () => `<h1>${escape(title)}</h1>`
      })}</div></div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/Typewriter-b26031ea.js
var Typewriter_b26031ea_exports = {};
__export(Typewriter_b26031ea_exports, {
  default: () => Typewriter
});
var css3, Typewriter;
var init_Typewriter_b26031ea = __esm({
  ".svelte-kit/output/server/chunks/Typewriter-b26031ea.js"() {
    init_shims();
    init_app_b78711c5();
    css3 = {
    ...
    Typewriter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      $$result.css.add(css3);
      return `<div style="${"--cursor-color: " + escape(typeof cursor === "string" ? cursor : "black")}" class="${["svelte-1371njd", cursor ? "cursor" : ""].join(" ").trim()}"${add_attribute("this", node, 0)}>${slots.default ? slots.default({}) : ``}</div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/index-bf656c89.js
var index_bf656c89_exports = {};
__export(index_bf656c89_exports, {
  default: () => Routes,
  load: () => load2
});
...
var Listing, PREVIOUS_PAGE, NEXT_PAGE, ELLIPSIS, PaginationNav, css4, LightPaginationNav, load2, pageSize, Routes;
var init_index_bf656c89 = __esm({
  ".svelte-kit/output/server/chunks/index-bf656c89.js"() {
    init_shims();
    init_app_b78711c5();
    init_index_862bbddd();
    init_Typewriter_b26031ea();
    Listing = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      let { title = "empty" } = $$props;
      let { subtitle = "empty" } = $$props;
      let { body = "empty" } = $$props;
      let { web = "empty" } = $$props;
      if ($$props.title === void 0 && $$bindings.title && title !== void 0)
        $$bindings.title(title);
      if ($$props.subtitle === void 0 && $$bindings.subtitle && subtitle !== void 0)
      ...
      if ($$props.web === void 0 && $$bindings.web && web !== void 0)
        $$bindings.web(web);
      return `<div class="${"card"}"><img src="${"https://picsum.photos/768"}" alt="${"Card example image"}">
  
    <div class="${"card-body"}"><h4 class="${"card-title"}">${escape(title.substr(0, 20))}</h4>
      <h5 class="${"card-subtitle"}">${escape(subtitle.substr(0, 20))}</h5>
      <p class="${"card-text"}">${escape(body.substr(0, 30))}</p>
      <button><a sveltekit:prefetch${add_attribute("href", web, 0)}>Info</a></button></div></div>`;
    });
    ...
    load2 = async ({ fetch: fetch2 }) => {
      const res = await fetch2("https://jsonplaceholder.typicode.com/posts");
    ...
    Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `<div class="${"paper container-lg"}"><h2>Listing bank, tempat investasi property</h2>
    ${validate_component(Typewriter, "Typewriter").$$render($$result, { loop: true }, {}, {
        default: () => `<h3>Bawah NJOP</h3>
        <h3>Property murah</h3>
        <h3>Harga Covid</h3>`
      })}</div>

<div class="${"paper container-md"}"><div class="${"row flex-spaces"}"><div class="${"form-group"}"><label for="${"paperInputs1"}">Kata kunci</label>
        <input type="${"text"}" placeholder="${"misal : ruko"}"${add_attribute("value", searchWord, 0)}></div>

      <div class="${"form-group"}"><label for="${"paperSelects1"}">Daerah</label>
        <select id="${"paperSelects1"}"><option value="${"1"}">Option 1</option><option value="${"2"}">Option 2</option><option value="${"3"}">Option 3</option></select></div>
      <div class="${"form-group"}"><label for="${"paperSelects1"}">Harga</label>
        <select id="${"paperSelects1"}"><option value="${"1"}">Bawah 1 M</option><option value="${"2"}">Bawah 3 M</option><option value="${"3"}">Bawah 5 M</option><option value="${"4"}">Bawah 10 M</option><option value="${"5"}">Diatas 10 M</option></select></div>

      <fieldset class="${"form-group"}"><legend>Some Check Boxes</legend>
        <label for="${"paperChecks1"}" class="${"paper-check"}"><input type="${"checkbox"}" name="${"paperChecks"}" id="${"paperChecks1"}" value="${"option 1"}"> <span>This is the first check</span></label>
        <label for="${"paperChecks2"}" class="${"paper-check"}"><input type="${"checkbox"}" name="${"paperChecks"}" id="${"paperChecks2"}" value="${"option 2"}"> <span>This is the second check</span></label></fieldset>

      ${validate_component(Button, "Button").$$render($$result, {}, {}, { default: () => `Cari` })}</div></div>

<div class="${"paper container-lg"}"><div class="${"row"}">${paginatedItems.length ? `${each(paginatedItems, (item) => `<div class="${"sm-6 md-4 lg-3 col"}">${validate_component(Listing, "Listing").$$render($$result, {
        title: item.title,
        subtitle: item.title,
        body: item.body,
        web: "./blog/" + item.id
      }, {}, {})}
        </div>`)}` : `<div class="${"row flex-spaces"}"><div class="${"alert alert-danger"}">Sorry, no data found <b><i>${escape(searchWord)}</i></b></div></div>`}</div>
...
// .svelte-kit/output/server/chunks/[id]-a6c817bd.js
var id_a6c817bd_exports = {};
__export(id_a6c817bd_exports, {
  default: () => U5Bidu5D,
  load: () => load3
});
var load3, U5Bidu5D;
var init_id_a6c817bd = __esm({
  ".svelte-kit/output/server/chunks/[id]-a6c817bd.js"() {
    init_shims();
    init_app_b78711c5();
    load3 = async ({ page, fetch: fetch2 }) => {
      const id = page.params.id;
      const myPath = "https://jsonplaceholder.typicode.com/posts/" + id;
      const res = await fetch2(myPath);
    ...
    U5Bidu5D = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      if ($$props.post === void 0 && $$bindings.post && post !== void 0)
        $$bindings.post(post);
      return `<div class="${"paper container-md"}"><h1>${escape(post.title)}</h1>
  <p>${escape(post.body)}</p>
  ${escape(JSON.stringify(post))}</div>`;
    });
  }
});

// .svelte-kit/output/server/chunks/app-b78711c5.js
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-4ce81f16.js",
      css: [assets + "/_app/assets/start-61d1577b.css", assets + "/_app/assets/vendor-d3edd439.css"],
      js: [assets + "/_app/start-4ce81f16.js", assets + "/_app/chunks/vendor-fef9037d.js"]
    },
    fetched: void 0,
    floc: false,
...
var __accessCheck, __privateGet, __privateAdd, __privateSet, _map, chars, unsafeChars, reserved, escaped$1, objectProtoOwnPropertyNames, subscriber_queue, escape_json_string_in_html_dict, escape_html_attr_dict, s$1, s, absolute, ReadOnlyFormData, current_component, escaped, missing_component, on_destroy, css5, Root, base, assets, user_hooks, template, options, default_settings, d, empty, manifest, get_hooks, module_lookup, metadata_lookup;
var init_app_b78711c5 = __esm({
  ".svelte-kit/output/server/chunks/app-b78711c5.js"() {
    init_shims();
...
${``}`;
    ...
    manifest = {
      ...
      routes: [
        ...
        },
        {
          ...
          pattern: /^\/Typewriter\/?$/,
          params: empty,
          a: ["src/routes/__layout.svelte", "src/routes/Typewriter.svelte"],
          b: ["src/routes/__error.svelte"]
        },
        {
          type: "page",
    ...
    module_lookup = {
      "src/routes/__layout.svelte": () => Promise.resolve().then(() => (init_layout_480af0fa(), layout_480af0fa_exports)),
      "src/routes/__error.svelte": () => Promise.resolve().then(() => (init_error_096c4eb0(), error_096c4eb0_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_bf656c89(), index_bf656c89_exports)),
      "src/routes/Typewriter.svelte": () => Promise.resolve().then(() => (init_Typewriter_b26031ea(), Typewriter_b26031ea_exports)),
      "src/routes/blog/[id].svelte": () => Promise.resolve().then(() => (init_id_a6c817bd(), id_a6c817bd_exports))
    };
    metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-0ca05092.js", "css": ["assets/paper.min-e6bf4bfa.css", "assets/Typewriter.svelte_svelte&type=style&lang-b59c545a.css", "assets/vendor-d3edd439.css"], "js": ["pages/__layout.svelte-0ca05092.js", "chunks/vendor-fef9037d.js"], "styles": [] }, "src/routes/__error.svelte": { "entry": "pages/__error.svelte-28720f90.js", "css": ["assets/vendor-d3edd439.css"], "js": ["pages/__error.svelte-28720f90.js", "chunks/vendor-fef9037d.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-499e9ebd.js", "css": ["assets/paper.min-e6bf4bfa.css", "assets/Typewriter.svelte_svelte&type=style&lang-b59c545a.css", "assets/vendor-d3edd439.css"], "js": ["pages/index.svelte-499e9ebd.js", "chunks/vendor-fef9037d.js", "pages/Typewriter.svelte-cde0be53.js"], "styles": [] }, "src/routes/Typewriter.svelte": { "entry": "pages/Typewriter.svelte-cde0be53.js", "css": ["assets/Typewriter.svelte_svelte&type=style&lang-b59c545a.css", "assets/vendor-d3edd439.css"], "js": ["pages/Typewriter.svelte-cde0be53.js", "chunks/vendor-fef9037d.js"], "styles": [] }, "src/routes/blog/[id].svelte": { "entry": "pages/blog/[id].svelte-b43d3676.js", "css": ["assets/vendor-d3edd439.css"], "js": ["pages/blog/[id].svelte-b43d3676.js", "chunks/vendor-fef9037d.js"], "styles": [] } };
  }
});
